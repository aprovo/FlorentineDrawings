...
with open('FlorentineDrawings_SpreadsheetsCombined_v3 - FlorentineDrawings_CombinedSpreadsheets.csv', 'r', encoding="UTF-8") as f:
	...
	for row in reader:
		...
		if BB_1938_Artist_NoQualifier == "" and BB_1938_number_letter != "":
			BB_1938_Artist_NoQualifier = BB_1961_Artist_NoQualifier
			...
			ArtistCellFilled_List.append(Artist_URI_1961)
...
#print(ArtistCellFilled_ListList)
		print(FlorentineDrawings_IdentifierBB1961, BB_1961_Artist_NoQualifier, BB_1938_number_letter, BB_1938_Artist_NoQualifier)


with open('FlorentineDrawings_AllArtistsFilledIn1938.csv', 'w', encoding="UTF-8") as f:
