...
with open('FlorentineDrawings_SpreadsheetsCombined_v4_LK_BM_URIs - FlorentineDrawings_CombinedSpreadsheets.csv', 'r', encoding="UTF-8") as f:
	reader = csv.reader(f)
	next(reader)
	for row in reader:
...
#data from the project.
		...
		drawingsubsubChild(Object_repository_URI, Object_repository_URI_name)
...
#data from the 1961 edition
		...
		drawingsubsubsubChild(BB_1961_Inventory_number, BB_1961_Inventory_number_name)
...
# write XML file
ElementTree(root).write("xml_1may.xml", encoding="UTF-8", xml_declaration=True, default_namespace=None)