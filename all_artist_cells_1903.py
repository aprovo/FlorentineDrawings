...
with open('FlorentineDrawings_SpreadsheetsCombined_v3 - FlorentineDrawings_CombinedSpreadsheetsFilledIn1938.csv', 'r', encoding="UTF-8") as f:
	reader = csv.reader(f)
	next(reader)
	for row in reader:
		...
		if BB_1903_Artist_NoQualifier == "" and BB_1903_number_letter != "":
			BB_1903_Artist_NoQualifier = BB_1938_Artist_NoQualifier
			...
			ArtistCellFilled_List.append(BB_1903_Artist_NoQualifier)		
			ArtistCellFilled_List.append(Artist_URI_1938)

		# elif BB_1938_Artist_NoQualifier != "" and BB_1938_number_letter != "" :
		# 	BB_1938_Artist_NoQualifier = BB_1938_Artist_NoQualifier

		# 	ArtistCellFilled_List.append(FlorentineDrawings_IdentifierBB1961)
		# 	ArtistCellFilled_List.append(BB_1961_Artist_NoQualifier)
		# 	ArtistCellFilled_List.append(BB_1961_number_letter)
		# 	ArtistCellFilled_List.append(BB_1938_number_letter)
		# 	ArtistCellFilled_List.append(BB_1938_Artist_NoQualifier)
...
#print(ArtistCellFilled_ListList)
		print(FlorentineDrawings_IdentifierBB1961, BB_1961_Artist_NoQualifier, BB_1903_number_letter, BB_1903_Artist_NoQualifier)


with open('FlorentineDrawings_AllArtistsFilledIn1903.csv', 'w', encoding="UTF-8") as f:
